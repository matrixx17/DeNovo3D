...
class Ligand:
    ...
    def finalize(self):
        ...
        self.elements = np.array(self.elements, dtype=np.int64)
...
ppath = '/Users/vedantajain/Research/DeNovo3D/6ugn_pocket.pdb'
lpath = '/Users/vedantajain/Research/DeNovo3D/6ugn_ligand.mol2'
